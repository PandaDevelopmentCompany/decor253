...
C:"ytp-mdx-popup-dialog",N:{role:"dialog"},J:[{X:"div",C:"ytp-mdx-popup-dialog-inner-content",J:[{X:"div",C:"ytp-mdx-popup-title",Rl:"\u0412\u044b \u0432\u044b\u0448\u043b\u0438 \u0438\u0437 \u0430\u043a\u043a\u0430\u0443\u043d\u0442\u0430"},{X:"div",C:"ytp-mdx-popup-description",Rl:'\u0420\u043e\u043b\u0438\u043a\u0438, \u043a\u043e\u0442\u043e\u0440\u044b\u0435 \u0432\u044b \u043f\u043e\u0441\u043c\u043e\u0442\u0440\u0438\u0442\u0435, \u043c\u043e\u0433\u0443\u0442 \u0431\u044b\u0442\u044c \u0434\u043e\u0431\u0430\u0432\u043b\u0435\u043d\u044b \u0432 \u0438\u0441\u0442\u043e\u0440\u0438\u044e \u043f\u0440\u043e\u0441\u043c\u043e\u0442\u0440\u0430 \u043d\u0430 \u0442\u0435\u043b\u0435\u0432\u0438\u0437\u043e\u0440\u0435, \u0447\u0442\u043e \u0441\u043a\u0430\u0436\u0435\u0442\u0441\u044f \u043d\u0430 \u0440\u0435\u043a\u043e\u043c\u0435\u043d\u0434\u0430\u0446\u0438\u044f\u0445. \u0427\u0442\u043e\u0431\u044b \u044d\u0442\u043e\u0433\u043e \u0438\u0437\u0431\u0435\u0436\u0430\u0442\u044c, \u0432\u044b\u0431\u0435\u0440\u0438\u0442\u0435 "\u041e\u0442\u043c\u0435\u043d\u0430" \u0438 \u0432\u043e\u0439\u0434\u0438\u0442\u0435 \u0432 \u0430\u043a\u043a\u0430\u0443\u043d\u0442 \u043d\u0430 \u043a\u043e\u043c\u043f\u044c\u044e\u0442\u0435\u0440\u0435.'},
{X:"div",C:"ytp-mdx-privacy-popup-buttons",J:[{X:"button",Fj:["ytp-button","ytp-mdx-privacy-popup-cancel"],Rl:"\u041e\u0442\u043c\u0435\u043d\u0430"},{X:"button",Fj:["ytp-button","ytp-mdx-privacy-popup-confirm"],Rl:"\u041e\u041a"}]}]}]});this.fade=new g.AV(this,250);this.cancelButton=this.DN("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.DN("ytp-mdx-privacy-popup-confirm");g.t(this,this.fade);this.Z(this.cancelButton,"click",this.K);this.Z(this.confirmButton,"click",this.j)},Wo=function(O){g.r.call(this,
{X:"div",
C:"ytp-remote",J:[{X:"div",C:"ytp-remote-display-status",J:[{X:"div",C:"ytp-remote-display-status-icon",J:[g.ryp()]},{X:"div",C:"ytp-remote-display-status-text",Rl:"{{statustext}}"}]}]});this.api=O;this.fade=new g.AV(this,250);g.t(this,this.fade);this.Z(O,"presentingplayerstatechange",this.onStateChange);this.gX(O.getPlayerStateObject())},Uv=function(O,V){g.og.call(this,"\u0412\u044b\u0431\u0435\u0440\u0438\u0442\u0435 \u0443\u0441\u0442\u0440\u043e\u0439\u0441\u0442\u0432\u043e \u0434\u043b\u044f \u043f\u0440\u043e\u0441\u043c\u043e\u0442\u0440\u0430",
1,O,V);
...
this.TX={key:Fry(),name:"\u042d\u0442\u043e\u0442 \u043a\u043e\u043c\u043f\u044c\u044e\u0442\u0435\u0440"};this.IK=null;this.subscriptions=[];this.ri=this.hx=null;this.NB=[this.TX];this.Ud=this.TX;this.Pf=new g.nr(64);this.N_=0;this.Kf=-1;this.qt=!1;this.lV=this.p8=this.Un=null;if(!g.Vw(this.player.Y())&&!g.pJ(this.player.Y())){O=this.player;var V=g.Lj(O);V&&(V=V.gq())&&(V=new Uv(O,V),g.t(this,V));V=new Wo(O);g.t(this,V);g.kD(O,V.element,4);this.Un=new xd;g.t(this,this.Un);g.kD(O,this.Un.element,
4);this.qt=!!Jl()}},Zo=function(O){O.p8&&(O.player.removeEventListener("presentingplayerstatechange",O.p8),O.p8=null)},ADz=function(O,V,J){O.Pf=J;
...
break;case -1:this.mA(new g.nr(64));break;case -1E3:this.mA(new g.nr(128,{errorCode:"mdx.remoteerror",errorMessage:"\u0412\u0438\u0434\u0435\u043e \u043d\u0435\u0434\u043e\u0441\u0442\u0443\u043f\u043d\u043e \u0434\u043b\u044f \u0443\u0434\u0430\u043b\u0435\u043d\u043d\u043e\u0433\u043e \u0432\u043e\u0441\u043f\u0440\u043e\u0438\u0437\u0432\u0435\u0434\u0435\u043d\u0438\u044f.",vj:2}))}O=qC(this.hx).trackData;var V=this.D;(O||V?O&&V&&O.trackName==V.trackName&&O.languageCode==V.languageCode&&O.languageName==
V.languageName&&O.kind==V.kind:1)||(this.D=O,KNd(this,O));O=qC(this.hx);O.volume===-1||Math.round(this.G.getVolume())===O.volume&&this.G.isMuted()===O.muted||this.qX.isActive()||this.kf()}else Qjn(this)};
...
Wo.prototype.gX=function(O){if(this.api.getPresentingPlayerType()===3){var V={RECEIVER_NAME:this.api.getOption("remote","currentReceiver").name};O=g.R(O,128)?g.kv('\u041e\u0448\u0438\u0431\u043a\u0430 \u043d\u0430 \u0443\u0441\u0442\u0440\u043e\u0439\u0441\u0442\u0432\u0435 "$RECEIVER_NAME"',V):O.isPlaying()||O.isPaused()?g.kv('\u0412\u043e\u0441\u043f\u0440\u043e\u0438\u0437\u0432\u0435\u0434\u0435\u043d\u0438\u0435 \u043d\u0430 \u0443\u0441\u0442\u0440\u043e\u0439\u0441\u0442\u0432\u0435 "$RECEIVER_NAME"',
V):g.kv('\u0423\u0441\u0442\u0430\u043d\u043e\u0432\u043b\u0435\u043d\u043e \u043f\u043e\u0434\u043a\u043b\u044e\u0447\u0435\u043d\u0438\u0435 \u043a \u0443\u0441\u0442\u0440\u043e\u0439\u0441\u0442\u0432\u0443 "$RECEIVER_NAME"',V);this.updateValue("statustext",O);this.fade.show()}else this.fade.hide()};g.I(Uv,g.og);Uv.prototype.j=function(){var O=this.G.getOption("remote","receivers");O&&O.length>1&&!this.G.getOption("remote","quickCast")?(this.NB=g.FC(O,this.K,this),this.w8(g.Ia(O,this.K)),O=this.G.getOption("remote","currentReceiver"),O=this.K(O),this.options[O]&&this.bB(O),this.enable(!0)):this.enable(!1)};
Uv.prototype.K=function(O){return O.key};
Uv.prototype.r0=function(O){return O==="cast-selector-receiver"?"\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c":this.NB[O].name};
